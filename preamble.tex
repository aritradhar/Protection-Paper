...
\lstdefinelanguage{HTML}
{
  ...
  morekeywords={form,input,encrypted_qr,Input}
}
...
\lstdefinelanguage{json}{
    ...
    morekeywords={formId, formName, signature, ui, dim, id, type, label, text, trigger, domain, sizeH, sizeW, size_x, size_y, enable, uiGap, size, SAS},
    literate=
     *{0}{{{\color{numb}0}}}{1}
      {1}{{{\color{numb}1}}}{1}
      {2}{{{\color{numb}2}}}{1}
