...
\myparagraph{TCB comparison} We now compare the TCB of \device with respect to some of the most popular open source browser projects. All of the codes are measured with the \texttt{cloc} open source code line counting tool.
