...
The delay in forwarding keystrokes is $170\ \mu s$, mouse events is $250 \mu s$ and frames is $30.76\ ms$. This allows the \device to achieve the maximum display frame rate of $32.5$ per second.
