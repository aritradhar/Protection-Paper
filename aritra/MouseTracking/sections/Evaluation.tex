...
\centering
\begin{tabular}{l | c}
\textbf{Projects} & \textbf{LOC/Binary size} \\\hline
...
\multicolumn{2}{c}{\textbf{JavaScript engines}}\\\hline
Chrome V8~\cite{V8} & $2,009,183$\\
Firefox SpiderMonkey~\cite{spiderMonkey} & $2,908,550$\\\hline
\multicolumn{2}{c}{\textbf{Desktop operating systems}}\\\hline
Ubuntu 18.10 (Debian) & $1.9$ GB\\
Manjaro Linux 15.0.4 (Arch) & $2$ GB\\\hline
\multicolumn{2}{c}{\textbf{\name \device}}\\\hline
HDMI interceptor + overlay & $1,911$\\ 
USB stack & $893$\\
Crypto stack & $3,500$\\ 
