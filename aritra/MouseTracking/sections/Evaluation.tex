...
\red{\myparagraph{TCB comparison} In Table~\ref{tab:loc}, we provide the TCB of \device with respect to some of the most popular open source browsers and JavaScript interpreter engines. All of the codes are measured with the \texttt{cloc} open source code line counting tool. The comparison provide }
