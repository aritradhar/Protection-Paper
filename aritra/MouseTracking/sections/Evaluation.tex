...
\centering
\begin{tabular}{l | c}
\textbf{Projects} & \textbf{LOC} \\\hline
\multicolumn{2}{c}{\textbf{Browser}}\\\hline
Chromium (Google Chrome)~\cite{chromium_2019} &  $25,163,547$\\
Mozilla Firefox~\cite{mozilla_2019} & $20,928,358$\\\hline
\multicolumn{2}{c}{\textbf{JavaScript engine}}\\\hline
Chrome V8~\cite{V8} & $2,009,183$\\
Firefox SpiderMonkey~\cite{spiderMonkey} & $2,908,550$\\\hline
\multicolumn{2}{c}{\textbf{\name}}\\\hline
\device HDMI interceptor + overlay & $1,911$\\ 
\device USB stack & $893$\\
\device Crypto stack & $27,200$\\ \hline
\end{tabular} 
\caption{\textbf{Comparisons of LOC}. }
\spacesave
\label{tab:loc}
\end{table}


\myparagraph{TCB comparison} In Table~\ref{tab:loc}, we provide the TCB of \device with respect to some of the most popular open source browsers and JavaScript interpreter engines. All of the codes are measured with the \texttt{cloc} open source code line counting tool.
