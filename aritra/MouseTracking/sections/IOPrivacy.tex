...
\red{The IO confidentiality could be viewed as a similar problem to the \emph{phishing} where providing input to an illegitimate UI (or website) leaks sensitive information. Similar to phishing protection, IO confidentiality requires the user for additional attention/operations.}
