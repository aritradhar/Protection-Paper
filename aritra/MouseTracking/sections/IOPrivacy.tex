...
SAS is one possible way to inform the user securely about the trusted overlay on the screen generated by the \device. However, one could implement other proposed approaches such as security indicators, or secret images~\cite{6894474}.
