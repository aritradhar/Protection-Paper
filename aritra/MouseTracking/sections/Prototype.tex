...
\begin{figure}[t]
	...
	\begin{center}
		\begin{subfigure}{0.4\textwidth}
		\centering
		\includegraphics[trim={0 5cm 21.5cm 0}, clip, scale=0.58]{setUp_1.pdf}
