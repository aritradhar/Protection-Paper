...
\lstset{language=HTML, frame=tb, caption=\textbf{Equivalent decrypted HTML page of Figure~\ref{snippet:encryptedHTML}.} , label = snippet:decryptedHTML, firstnumber =1}
\begin{figure}[t]
\small
\begin{lstlisting}[mathescape=true]
<!DOCTYPE html>
