...
\begin{enumerate}
  ...
  \item[\seven] The \device analyzes the frames (from step \four) from the host using the UI information (step \six) received from the server. The analysis step is discussed in details in Section~\ref{sec:idea:analysis}.
...
\begin{figure}
\centering
\includegraphics[trim={0 11cm 17cm 0}, clip, width=\linewidth]{inputPrivacy.pdf}
