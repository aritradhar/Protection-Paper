...
\centering
\begin{tabular}{l | c | c}
\textbf{Operation} & \textbf{Average time} & \textbf{SD} \\ \hline
Detecting mouse pointer $(A)$ & 1.76 ms & 0.033 ms\\
Detection QR code $(B)$ & 14 ms & 2.33 ms\\
Decoding QR code + Overlay $(C)$ & 6 ms & 0.56 ms\\
Effective display latency $(A+B+C)$ & 21.76 ms &\\
Mouse latency & 250 $\mu$s & 12 $\mu$s\\
Keyboard latency & 170 $\mu$s & 8 $\mu$ s\\\hline
\end{tabular} 
