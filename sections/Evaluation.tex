...
\myparagraph{TCB comparison} We now compare the TCB of \device with respect to some of the most popular open source browser projects.

\begin{table}[h]
\scriptsize
\centering
\begin{tabular}{l | c}
\textbf{Project} & \textbf{LOC} \\\hline
Chromium (Google Chrome)~\cite{chromium_2019} &  $25,163,547$\\
Mozilla Firefox~\cite{mozilla_2019} & $20,505,184$\\
\textbf{\name} & \todo{}\\ \hline
\end{tabular} 
