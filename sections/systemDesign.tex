...
In the previous sections, we provide the mechanisms to provide output integrity. Note that the output integrity is crucial to ensure input integrity as the untrusted host may show arbitrary information to to the user (via the untrusted part of the display space) that may influence user. Hence, its is necessary to  

\subsubsection{Secure Attention Sequence}
