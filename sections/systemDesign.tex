...
\subsection{Finding Mouse Pointer in the HDMI Frame}
...
%\includegraphics[trim={0 13.5cm 21cm 0}, clip, width=0.65\linewidth]{uiDetect_1.pdf}
...
\subsection{Strawman solution: Text/Image Analysis of the UIs}
