...
\subsection{Privacy of the Pointer}
\label{sec:systemnDesign:mousePrivacy}

The host system can be made fully oblivious of the mouse pointer for a very small portion of the browser that handles sensitive data or operations.
