...
\red{
\myparagraph{Multiple HIDs} The attacker can emulate multiple HIDs to trick the tracking of the mouse pointer. However, this attack is ineffective as the \device only tracks the mouse pointer that is connected to it (over USB interface). }
