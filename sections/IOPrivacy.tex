...
\myparagraph{Establishing a Secure channel} The \device and the server create a secure channel using the public certificates. Our prototype implementation uses \tls for the secure channel. Implementation details are provided in Section~\ref{sec:prototype:impl:tls}. 
